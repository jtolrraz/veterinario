class PetHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pet_history.save
        format.html { redirect_to pet_pet_history_path(@pet,@pet_history), notice: 'Historial creado.' }
  ...
  def update
    ...
    respond_to do |format|
      if @pet_history.update(pet_history_params)
        format.html { redirect_to pet_pet_history_path(@pet,@pet_history), notice: 'Historial agregado.' }
